...
public class Test {
	...
	public Test(String name, int age) throws NotProperNameException {
		if (!containsAlphabet(name) && name != null) {
			...
			throw exName;// This is compile time exception.it will give you exception you need to handle
	...
	public static void main(String[] args) throws NotProperNameException {
		...
		int age = sc.nextInt();// This is compile time exception.it will give you exception you need to handle
								// this by try catch or throws
